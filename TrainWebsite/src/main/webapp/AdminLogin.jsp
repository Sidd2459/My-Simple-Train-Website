...
<form class="login100-form validate-form" action="al" method="post">
...
if(login_msg!=null)
out.println("<font color=red size=2px align=center><b>"+login_msg+"</b></font>");
%>
...
<a href="AdminRegister.jsp" class="txt2 hov1">
 Register Now
</a>
</div>
